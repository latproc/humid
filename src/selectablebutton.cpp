...
SelectableButton::SelectableButton(const std::string kind, Palette *pal, nanogui::Widget *parent,
...
bool SelectableButton::mouseButtonEvent(const nanogui::Vector2i &p, int button, bool down,
                                        int modifiers) {
...
nanogui::Widget *SelectableButton::create(nanogui::Widget *container) const { return 0; }
