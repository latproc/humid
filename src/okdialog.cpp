...
class ClockworkExample : public nanogui::Screen {
  ...
  public:
    ClockworkExample()
        : nanogui::Screen(nanogui::Vector2i(1024, 768), "NanoGUI Test", true, false), window(0),
          subscription_manager(0), disconnect_responder(0), connect_responder(0), iosh_cmd(0),
          cmd_interface(0), next_device_num(0), next_state_num(0), scale(1000),
          window_stagger(this) {
