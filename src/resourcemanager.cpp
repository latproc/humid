...
TextureResourceManager::TextureResourceManager(int texture_id, int init_refs)
    : ResourceManager(texture_id, init_refs) {}
...
ResourceManager *TextureResourceManagerFactory::create() const {
    return new TextureResourceManager();
}
ResourceManager *TextureResourceManagerFactory::create(int item_id, int refs) const {
    return new TextureResourceManager(item_id, refs);
}
