...
class TimeSeries {
  public:
    ...
    void draw(NVGcontext *ctx, Vector2i &pos, Vector2i &siz, const Axis &y_axis, uint64_t x_min,
              uint64_t x_max, float x_scale, bool show_name = true);
...
class NANOGUI_EXPORT LinePlot : public Widget {
  public:
    ...
    void drawGrid(NVGcontext *ctx, int x_start, double x_step, int num_x_steps, int y_start,
